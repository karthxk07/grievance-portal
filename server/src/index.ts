...
import {
  changeGrievanceStatusController,
  deleteGrievanceController,
  getGrievancesController,
} from "./controllers/GrievancesControllers";
...
app.get("/", (_, res: Response) =>
  statusOkay(res, { message: "Welcome to VITB Grienvances" })
);

app.get("/ping", (_, res: Response) =>
  statusOkay(res, { message: "Server Running" })
);
